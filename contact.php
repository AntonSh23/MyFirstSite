...
header("Content-Type: text/html; charset=utf-8");
    ...
    if (empty($_SESSION["user"])){echo "<script>alert('Вы должны зарегестрироваться или войти');</script>";
        header('Refresh: 0; URL=http://localhost/xdxdxd1234.ru/index.php');}
?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8">
...
<div class="container">
    <div class="row" id="feedback">
        <form method="post" action="send.php" id="contactform">
                <h3>Здравствуйте, пишите свои комментарии по поводу разработки сайта, буду признателен, если будет много конструктивной критики!</h3>
                <label for="message"><strong>Сообщение:</strong></label>
                <textarea rows="5" cols="50" name="message" id="message" required> </textarea>
