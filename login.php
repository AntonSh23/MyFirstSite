...
<div class="container">
    <div class="row">
        ...
        <form method="post" action="login.php" id="logform" style="margin-top: 10%">
...
<?php
if (empty($password)) {
    echo "<p style='text-align: center;'>Введите логин и пароль</p>";
}
else if ($user_data[4] == $password){
    $_SESSION["user"] = $login;
    echo "<script>alert('Вы успешно залогинены')</script>";
    header('Refresh: 0 ; URL=index.php');
}
else if ($user_data[4] != $password) {echo "<script>alert('Логин и пароль не совпадают')</script>";}
?>
